...
<div class="front-inner front-inner-media">
    <div class="container">
        ...
        <div class="front-toolbar other">
            ...
            <a href="javascript:void(0)" data-toggle="front-modal" data-title="发布通知" data-href="views/theme/create_notice.jsp?themeId=${theme.id}" class="btn btn-primary pull-right">发布通知</a>
        </div>
        <div id="tab">
